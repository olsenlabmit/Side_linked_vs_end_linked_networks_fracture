### Calculate depercolation threshold - break T1 chains only #####
...
directory_path='./deperc_T1_break_only'
...
##               all_edges=
               ...
               edges_with_target_weight=[ (u, v) for u, v, d in G_temp.edges(data=True) if d.get('weight') == target_weight ]
               #print(len(edges_with_target_weight),len(G_temp.edges()))
               init_num_bonds=G_temp.number_of_edges()#len(edges_with_target_weight)#G_temp.number_of_edges()

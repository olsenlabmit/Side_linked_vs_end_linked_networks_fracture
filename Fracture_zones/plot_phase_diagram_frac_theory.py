  ...
  try:
     ...
     if(U0_1>=U0_2):
      if(d_1>(U0_1-U0_2)/fmin+d_2):
            plt.plot(U0_1-U0_2,d_1-d_2,'s',markersize=12,color='#f2a0a0',markeredgecolor='black', markeredgewidth=1.5)##ffcfcf
      elif(d_1<=(U0_1-U0_2)/fmin+d_2 and d_1>=(U0_1-U0_2)/fmax+d_2):
            plt.plot(U0_1-U0_2,d_1-d_2,'s',markersize=12,color='#b3b3fc',markeredgecolor='black', markeredgewidth=1.5)##dbdbff
      elif(d_1<(U0_1-U0_2)/fmax+d_2): ## if equal
        plt.plot(U0_1-U0_2,d_1-d_2,'s',markersize=12,color='#fae29b',markeredgecolor='black', markeredgewidth=1.5)##fff2cc
        
     elif(U0_1<U0_2):
      if(d_1<(U0_1-U0_2)/fmin+d_2):
            plt.plot(U0_1-U0_2,d_1-d_2,'s',markersize=12,color='#fae29b',markeredgecolor='black', markeredgewidth=1.5)
      elif(d_1>=(U0_1-U0_2)/fmin+d_2 and d_1<=(U0_1-U0_2)/fmax+d_2):
            plt.plot(U0_1-U0_2,d_1-d_2,'s',markersize=12,color='#a2dbfc',markeredgecolor='black', markeredgewidth=1.5)##ccecff
      elif(d_1>(U0_1-U0_2)/fmax+d_2): ## if equal
        plt.plot(U0_1-U0_2,d_1-d_2,'s',markersize=12,color='#f2a0a0',markeredgecolor='black', markeredgewidth=1.5)
     ...
     if(U0_1>=U0_2):
      if(d_1>(U0_1-U0_2)/fmin+d_2):
            plt.plot(U0_1-U0_2,d_1-d_2,'s',markersize=12,color='#f2a0a0',markeredgecolor='black', markeredgewidth=1.5)##ffcfcf   pink
      elif(d_1<=(U0_1-U0_2)/fmin+d_2 and d_1>=(U0_1-U0_2)/fmax+d_2):
            plt.plot(U0_1-U0_2,d_1-d_2,'s',markersize=12,color='#b3b3fc',markeredgecolor='black', markeredgewidth=1.5)##dbdbff   ## light violet
      elif(d_1<(U0_1-U0_2)/fmax+d_2): ## if equal
        plt.plot(U0_1-U0_2,d_1-d_2,'s',markersize=12,color='#fae29b',markeredgecolor='black', markeredgewidth=1.5)##fff2cc  ## light yellow
        
     elif(U0_1<U0_2):
      if(d_1<(U0_1-U0_2)/fmin+d_2):
            plt.plot(U0_1-U0_2,d_1-d_2,'s',markersize=12,color='#f2a0a0',markeredgecolor='black', markeredgewidth=1.5) ## pink
      elif(d_1>=(U0_1-U0_2)/fmin+d_2 and d_1<=(U0_1-U0_2)/fmax+d_2):
            plt.plot(U0_1-U0_2,d_1-d_2,'s',markersize=12,color='#a2dbfc',markeredgecolor='black', markeredgewidth=1.5)##ccecff  # light blue
      elif(d_1>(U0_1-U0_2)/fmax+d_2): ## if equal
        plt.plot(U0_1-U0_2,d_1-d_2,'s',markersize=12,color='#f2a0a0',markeredgecolor='black', markeredgewidth=1.5)  ## pink
     fmin_line_arr.append(d_1-((U0_1-U0_2)/fmin+d_2))
     fmax_line_arr.append(d_1-((U0_1-U0_2)/fmax+d_2))    
...
sc = plt.scatter(delta_U0_arr, delta_d_arr,s=145, c=tough_arr, marker='s',  cmap='inferno', vmin=0, vmax=max(tough_arr), edgecolors='k',linewidths=1.0)
...
plt.savefig('delta_U-delta_d_phase_diag.png', dpi=600, transparent=True)
plt.show()

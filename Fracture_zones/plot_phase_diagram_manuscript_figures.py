...
U0_arr_init=[-10,-5,-2,-1,-0.5,-0.1,0,1,1.5,2,5,10,15,20,30,40,50,0.8]
d_arr_init=[0.0,0.01,0.05,0.1,0.15,0.2,0.3,0.4,0.5,0.8,1.0,1.2,1.5,2.0]
...
#'''
# Define custom colormap: white -> light blue -> dark blue
#colors = ["white", "#add8e6", "#00008b"][::-1]  # light blue hex is #add8e6, dark blue is #00008b
#custom_cmap = LinearSegmentedColormap.from_list("white_light_dark_blue", colors)
...
plt.savefig('manuscript_delta_U-delta_d_phase_diag.pdf', dpi=600, transparent=True)
plt.show()
